...
function expandArticleBody() {
  var buttons = document.querySelectorAll('.expand_button');

  var _iterator = _createForOfIteratorHelper(buttons.values()),
      _step;
...
function highlightArticle() {
  ...
  var _iterator2 = _createForOfIteratorHelper(highlightButtons.values()),
      _step2;

  try {
    var _loop2 = function _loop2() {
      var hiButton = _step2.value;
      hiButton.addEventListener('click', function (event) {
        var article = event.target.closest('article');
